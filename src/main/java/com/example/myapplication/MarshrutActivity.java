...
public class MarshrutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> open_app_create());
    }
    ...
    public void open_app_create(){
        Intent i = new Intent (this, CreateMarshrutActivity.class);
        startActivity(i);
    }
}